...
DATABASES = {
    'default': {
        ...
        'NAME': '%DASH_DATABASE_NAME%',
        'USER': '%DASH_DATABASE_USER%',
        'PASSWORD': '%DASH_DATABASE_PASS%',
        'HOST': '%DASH_DATABASE_HOST%',
...
OPENSTACK_KEYSTONE_URL = "http://%KEYSTONE_HOST_IP%:5000/v2.0/"
OPENSTACK_KEYSTONE_ADMIN_URL = "http://%KEYSTONE_HOST_IP%:35357/v2.0"
